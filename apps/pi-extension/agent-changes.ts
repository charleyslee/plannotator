...
export function createPiAgentDiffProvider(ctx: ExtensionContext, repoRoot: string): AgentDiffProvider | null {
	const header = ctx.sessionManager.getHeader() as { parentSession?: string } | null;
	return createPiAgentDiffProviderFromEntries(
